...
CREATE TABLE `plato` (
  ...
  CONSTRAINT `cat_id` FOREIGN KEY (`cat_id`) REFERENCES `categoria` (`cat_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `plato` VALUES (1,2,'Encebollado','Sopa','Medio',5),(2,2,'Ceviche','Sopa','Medio',5),(3,2,'Arroz camaron','Seco','Medio',5),(4,2,'Pescado frito','Seco','Medio',5),(5,2,'Tallarin con pollo','Seco','Medio',5),(6,2,'Arroz con carne','Seco','Facil',6),(7,2,'Arroz con pollo','Seco','Facil',6),(8,2,'Carne apanada','Seco','Facil',6),(9,2,'Pollo apanado','Seco','Facil',6),(10,5,'Michelada','Liquido','Facil',2);
...
INSERT INTO `plato_ingrediente` VALUES (1,1,1),(1,6,1),(1,7,1),(1,12,2),(2,1,1),(2,3,1),(2,6,2),(2,15,2),(3,5,2),(3,6,2),(3,15,2),(4,7,1),(4,8,1),(4,12,2),(4,21,2),(5,10,3);
...
-- Dump completed on 2023-07-31 13:03:59
